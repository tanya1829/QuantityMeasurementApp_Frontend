...
const AddPanel = ({ addToHistory, user, onLoginClick }) => {
  ...
  const handleAdd = () => {
    ...
    if (category === "temperature") {
      ...
      sum = (b1 + b2) / unitCategories[category].units[resultUnit].toBase;
    }
  ...
  return (
    <div className="panel add-panel">
      <div className="panel-header">
        <h2 className="panel-title">Add Quantities</h2>
        <p className="panel-subtitle">Sum values across different units</p>
      </div>
      ...
      <div className="operation-body">
        <div className="operand-row">
          ...
          <div className="operator-badge">+</div>
          <div className="operand-block">
        ...
        <button className="action-btn add-btn" onClick={handleAdd} disabled={!value1 || !value2}>
          Calculate Sum →
        </button>
        {result !== null && (
